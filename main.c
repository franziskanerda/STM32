// Um ein einzelnes C File bzw Teile davon f�r Debugzwecke nicht zu optimieren kann man den
// betreffenden Sourcecode mit den Zeilen
// #pragma GCC optimize 0
// #pragma GCC reset_options
// umgeben. Wichtig ist das die ge�nderte Optimierung mit dem reset_options wieder resettet wird!
...
int main( void ) 
{
	...
	// Der SysTick Timer wird zur Erzeugung von 10ms Interrupts verwendet. Der Timer l�uft mit
	// 1MHz. Reloadvalue auf 9999 (10000 - 1) ergibt 10ms. H�chste Priorit�t damit andere IRQs
	// zuverl�ssig auf Delay-Routinen zugreifen k�nnen.
	...
	PowerInit();								// erst mal alles abschalten au�er 3V3 und 5V
